(function () {
  ...
  var petActions = {
    blink: { duration: 720, priority: 20, status: "BLINK", detail: "frame +1", fx: "blink", lines: ["刚才那一下，我用眼睛接住了。", "眨一下。还在这儿。"] },
    nod: { duration: 980, priority: 30, status: "ACK", detail: "signal received", fx: "pulse", lines: ["嗯。尾巴知道了。", "收到，先压在爪子底下。"] },
    walk: { duration: 1750, priority: 20, status: "PATROL", detail: "edge check", fx: "trail", lines: ["我绕一圈，闻闻页面边上。", "换块地方趴。时间继续走。"] },
    paw: { duration: 1120, priority: 30, status: "POKE", detail: "pointer ping", fx: "pixels", lines: ["碰到了。爪垫比鼠标软一点。", "你点我，我就点回来。"] },
    hop: { duration: 1280, priority: 30, status: "JUMP", detail: "stack +1", fx: "impact", lines: ["你点得有点重，我整只猫弹了一下。", "弹起来了。四只脚都落回原位。"] },
    stretch: { duration: 1580, priority: 20, status: "STRETCH", detail: "cache loosened", fx: "wave", lines: ["先把前爪伸长一点。", "像素会僵，猫也会。"] },
    nap: { duration: 2380, priority: 20, status: "SLEEP", detail: "wake on input", fx: "sleep", lines: ["我眯两秒。耳朵还开着。", "这里温度刚好，趴一下。"] },
    hide: { duration: 1780, priority: 20, status: "FORK", detail: "below viewport", fx: "trail", lines: ["我去下面藏一小会儿。", "页面底下有块阴影，我借一下。"] },
    peek: { duration: 1480, priority: 20, status: "PEEK", detail: "read pointer", fx: "scan", lines: ["从边上看你一眼。", "光标还在动。那我也醒着。"] },
    glitch: { duration: 1080, priority: 30, status: "GLITCH", detail: "self-healed", fx: "glitch", lines: ["毛炸了一帧。已经舔平了。", "刚才不是卡，是我抖了抖耳朵。"] },
    turn: { duration: 1460, priority: 30, status: "FLIP", detail: "render reverse", fx: "pixels", lines: ["尾巴那边也想看看。", "转过去听听后面有没有动静。"] },
    inspect: { duration: 1580, priority: 30, status: "TRACE", detail: "pointer clean", fx: "scan", lines: ["这个点击有点香。我闻一下。", "请求不大，一只爪能处理。"] },
    scrub: { duration: 1560, priority: 20, status: "CLEAN", detail: "linting fur", fx: "sparks", lines: ["毛里粘了两粒旧缓存。", "舔干净了。别问我什么味道。"] },
    compile: { duration: 1780, priority: 50, status: "BUILD", detail: "time graph", fx: "compile", lines: ["时间挪好了。我踩过三处刻度。", "三枚时间都在原位，尾巴没扫乱。"] },
    packet: { duration: 1420, priority: 50, status: "QUEUE +1", detail: "tomorrow task", fx: "packet", lines: ["明早多了一件。我把它压在爪下。", "先放进明早那只盒子。"] },
    pass: { duration: 1280, priority: 50, status: "TEST PASS", detail: "task complete", fx: "pass", lines: ["划掉了。爪印还留着。", "这一件做完，尾巴翘一下。"] },
    rollback: { duration: 1450, priority: 50, status: "ROLLBACK", detail: "state restored", fx: "rollback", lines: ["又拿回来了。还温热。", "放回待办。位置我记得。"] },
    purge: { duration: 1460, priority: 50, status: "CLEAR", detail: "undo available", fx: "purge", lines: ["清单空了。刚才那堆藏在垫子下面。", "我把它们扫到恢复那边了。"] },
    handoff: { duration: 2100, priority: 60, status: "COMMIT OK", detail: "saved locally", fx: "commit", lines: ["停在这里。明早我还认得这个味道。", "这页我趴住了，明早接着翻。"] },
    celebrate: { duration: 2300, priority: 65, status: "ALL GREEN", detail: "queue empty", fx: "celebrate", lines: ["都划掉了。允许摸一下尾巴。", "明早那只盒子，空得很漂亮。"] },
    warning: { duration: 1900, priority: 70, status: "TIMEBOX", detail: "attention", fx: "warning", lines: ["时间到脚边了。", "收工那格正在发热。"] },
    theme: { duration: 1450, priority: 45, status: "RE-SKIN", detail: "palette loaded", fx: "theme", lines: ["换了片光。我的毛也跟着变色。", "这身颜色适合在这里趴。"] },
    purr: { duration: 2600, priority: 60, status: "PURR", detail: "hold signal", fx: "purr", lines: ["嗯——这里摸得到呼噜。", "再按一会儿，我把页面震松。"] },
    reboot: { duration: 2200, priority: 65, status: "REBOOT", detail: "double click", fx: "reboot", lines: ["抖抖毛，还是原来那只。", "刚才翻了个面，记忆没掉。"] },
    breathe: { duration: 1700, priority: 50, status: "SLOW LOOP", detail: "4 / 2 / 6", fx: "purr", lines: ["你慢慢呼吸，我跟着起伏。", "三轮。够我打一个小呼噜。"] },
    capture: { duration: 3000, priority: 90, status: "POINTER LOCK", detail: "release in 3s", fx: "capture", lines: ["鼠标给我玩三秒。只咬光标，不咬文件。"] }
  };
  ...
  var focusScenes = [
    { id: "nudge", duration: 3900, status: "ALIGN", detail: "seconds +8px", line: "最后两位挤过来了。我用鼻子推开一点。" },
    { id: "watch", duration: 4300, status: "WATCH", detail: "sampling ticks", line: "它一跳，我耳朵就动一下。" },
    { id: "cross", duration: 4900, status: "PATROL", detail: "timer edge", line: "我沿数字走一圈，尾巴别扫到秒针。" },
    { id: "pounce", duration: 3800, status: "CATCH", detail: "next tick", line: "等下一秒掉下来，我扑。" },
    { id: "sleep", duration: 4700, status: "POWER NAP", detail: "clock awake", line: "借秒数旁边的热气趴两秒。" },
    { id: "checksum", duration: 4200, status: "CHECKSUM", detail: "hh:mm:ss", line: "都闻过了。三个数字没串味。" },
    { id: "borrow", duration: 3900, status: "BORROW", detail: "colon x1", line: "这个冒号像两粒猫粮。借一粒。" },
    { id: "cursor", duration: 4100, status: "TAIL -F", detail: "live seconds", line: "我守在最后两位后面，看它还敢不敢跑。" }
  ];
  ...
  function renderPhase(now) {
    ...
    var percent = (now.getHours() * 60 + now.getMinutes() + now.getSeconds() / 60) / 1440 * 100;
  ...
  function recommendedPlan() {
    ...
    playPetAction("compile", {
      line: "从 " + state.wake + " 往回踩： " + state.off + " 收爪，" + state.bed + " 团成一团。"
    });
  }
  ...
  function renderTasks() {
    ...
    state.tasks.forEach(function (task) {
      ...
      check.addEventListener("click", function () {
        ...
        if (allDone) {
          playPetAction("celebrate", { line: isMorningReview() ? "今天这几件都做完了。尾巴可以翘一下。" : "明早那只盒子空了。尾巴可以翘一下。" });
        } else if (task.done) {
          playPetAction("pass", { line: "“" + task.text + "”划掉了。爪印还在。" });
        } else {
          playPetAction("rollback", { line: "“" + task.text + "”又放回来了。位置没丢。" });
        }
      });
      ...
      remove.addEventListener("click", function () {
        ...
        saveState();
        renderTasks();
        playPetAction("purge", { line: isMorningReview() ? "这条叼走了。今天少一件。" : "这条叼走了。明早少一件。" });
      });
  ...
  function addTask() {
    ...
    saveState();
    renderTasks();
    playPetAction("packet", { line: isMorningReview() ? "“" + text + "”放进今天这只盒子。" : "“" + text + "”放进明早那只盒子。" });
  }
    ...
    steps.forEach(function (step, index) {
      ...
      button.addEventListener("click", function () {
        ...
        if (state.checks.every(Boolean)) {
          playPetAction("celebrate", { line: "四件都收好。我去床边占位置。" });
        } else if (state.checks[index]) {
          playPetAction("pass", { line: "这一件收好。还剩 " + state.checks.filter(function (checked) { return !checked; }).length + " 件。" });
        } else {
          playPetAction("rollback", { line: "这件又放回来了。先搁这儿。" });
        }
      });
  ...
  function handoff() {
    ...
    if (!state.dump && !state.tasks.length) {
      ...
      el.dump.focus();
      playPetAction("inspect", { priority: 55, status: "NEED INPUT", detail: "handoff empty", line: "这里还空着。留一句，明早一闻就知道做到哪儿了。" });
      return;
    }
  ...
  function finishBreathing() {
    ...
    setBreathScale(1);
    playPetAction("nod", { force: true, line: "三轮。呼吸已经慢下来了。" });
  }
  ...
  function pauseBreathing() {
    ...
    breathFrame = 0;
    renderBreathing(now);
    playPetAction("nod", { line: "先停在这一口。等你接着来。" });
  }
  ...
  function resumeBreathing() {
    ...
    breathClock.status = "running";
    breathClock.runStartedAt = performance.now();
    playPetAction("breathe", { line: "接着来。我继续跟着起伏。" });
    renderBreathing(breathClock.runStartedAt);
  }
  ...
  function completeNight() {
    ...
    playPetAction("celebrate", { force: true, line: "今晚收好了。我去睡成一团。" });
  }
  ...
  function resetTonight() {
    ...
    renderWinddown();
    renderPhase(new Date());
    playPetAction("rollback", { force: true, line: "今晚重新摊开。时间和月历我没碰。" });
  }
  ...
  function captureMouse(event) {
    ...
    captureTimer = window.setTimeout(function () { releaseCapture(false); }, 3000);
  }

  function touchCat(event) {
    if (captureTimer) {
      speakCat("还咬着。三秒到了就吐出来。");
      return;
    }
  ...
  function handleTimeChange(select) {
    ...
    var labels = {
      "off-time": state.off + " 收爪。我在那格旁边等。",
      "bed-time": state.bed + " 团成一团。今晚有 " + durationText(durationMinutes(state.bed, state.wake)) + " 可睡。",
      "wake-time": state.wake + " 睁眼。我往前嗅一遍时间。"
    };
    var buffer = durationMinutes(state.off, state.bed);
    if (buffer < 30) {
      playPetAction("warning", {
        line: "只剩 " + buffer + " 分钟洗漱。这个缝有点窄。"
      });
    } else {
  ...
  function monitorPetClock(now) {
    ...
    if (!lastPhaseId) {
      ...
      if (phase.id === "winddown") {
        playPetAction("warning", { force: true, status: "STOP WORK", detail: "wind-down started", line: "到点了。关资料吧，我去门口等你。" });
      } else if (phase.id === "sleep") {
        playPetAction("nap", { force: true, priority: 70, line: "该睡了。我先把自己团起来。" });
      }
    }
    if (phase.id !== "work") {
    ...
    if (threshold !== lastThreshold && threshold !== "far") {
      ...
      playPetAction("warning", {
        line: minutes <= 5
          ? "还剩 " + minutes + " 分钟。先把手里的线头压住。"
          : "还有 " + minutes + " 分钟。我开始绕着收工那格走。"
      });
    } else {
      lastThreshold = threshold;
    }
  ...
  function qaEvent(name) {
    var map = {
      "time-change": ["compile", "时间挪好了。我踩过三处刻度。"],
      "task-add": ["packet", "明早多了一件。我把它压在爪下。"],
      "task-done": ["pass", "划掉了。爪印还留着。"],
      "all-done": ["celebrate", "明早那只盒子空了。"],
      "task-clear": ["purge", "我把清单扫到恢复那边了。"],
      "task-undo": ["rollback", "又拿回来了。还温热。"],
      "handoff": ["handoff", "停在这里。明早我还认得。"],
      "warning": ["warning", "时间到脚边了。"],
      "theme": ["theme", "换了片光。毛也跟着变色。"],
      "breathe": ["breathe", "你慢慢呼吸，我跟着起伏。"]
    };
  ...
  el.breathReset.addEventListener("click", function () {
    ...
    clearBreathing();
    if (hadStarted) playPetAction("rollback", { line: "重来。刚才那几口不算账。" });
  });
